...
package ca.tweetzy.skulls.feather.config;
...
public interface ConfigEntry {
    ...
    /**
     * @return <code>&lt;configVersion, Tuple&lt;keyInGivenVersion, valueConverter&gt;&gt;</code>
     */
    @Nullable
    ...
    @Contract("!null -> !null")
    default @Nullable
    String getStringOr(String fallbackValue) {
        Object value = get();
    ...
    @Contract("!null -> !null")
    default @Nullable
    List<String> getStringListOr(List<String> fallbackValue) {
        Object value = get();
    ...
    /**
     * @see #getMaterialOr(ca.tweetzy.skulls.feather.comp.enums.CompMaterial)
     */
    ...
    @Contract("!null -> !null")
    default @Nullable
    CompMaterial getMaterialOr(@Nullable CompMaterial defaultValue) {
        String value = getString();
