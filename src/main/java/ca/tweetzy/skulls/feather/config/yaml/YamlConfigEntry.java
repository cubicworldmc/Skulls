...
package ca.tweetzy.skulls.feather.config.yaml;

import ca.tweetzy.skulls.feather.config.ConfigEntry;
import ca.tweetzy.skulls.feather.config.IConfiguration;
import ca.tweetzy.skulls.feather.config.WriteableConfigEntry;
import ca.tweetzy.skulls.feather.utils.Tuple;
...
public class YamlConfigEntry implements WriteableConfigEntry {
    ...
    protected @Nullable
    Map<Integer, Tuple<String, Function<Object, Object>>> upgradeSteps;
    ...
    @Override
    public @Nullable
    Map<Integer, Tuple<String, Function<Object, Object>>> getUpgradeSteps() {
    ...
    public ConfigEntry withUpgradeStep(int version, @Nullable String keyInGivenVersion, @Nullable Function<Object, Object> valueConverter) {
        ...
        this.upgradeSteps.put(version, new Tuple<>(keyInGivenVersion, valueConverter));
