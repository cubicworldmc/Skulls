...
import static ca.tweetzy.skulls.feather.files.comments.format.YamlCommentFormatterConfiguration.DEFAULT_COMMENT_PREFIX;
import static ca.tweetzy.skulls.feather.files.utils.StringUtils.BLANK_LINE;
