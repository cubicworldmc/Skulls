package ca.tweetzy.skulls.feather.files.configuration.file;

import ca.tweetzy.skulls.feather.files.configuration.Configuration;
import ca.tweetzy.skulls.feather.files.configuration.LoadableConfiguration;
import ca.tweetzy.skulls.feather.files.configuration.MemoryConfiguration;
